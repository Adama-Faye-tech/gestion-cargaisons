...
Calcul automatique des frais de transport selon les tarifs définis Gestion des contraintes de transport (chimique uniquement maritime,fragile jamais maritime)
Option express (coût × 10)
...
excecutez le fichier main.py (run)
